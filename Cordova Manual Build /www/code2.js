...
gdjs.Login_95ScreenCode.asyncCallback12398492 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Login_95ScreenCode.asyncCallback12398492(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Login_95ScreenCode.asyncCallback7758060 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Login_95ScreenCode.asyncCallback7758060(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Login_95ScreenCode.asyncCallback11984772 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Login_95ScreenCode.asyncCallback11984772(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Login_95ScreenCode.asyncCallback11923108 = function (runtimeScene, asyncObjectsList) {
gdjs.copyArray(asyncObjectsList.getObjects("Notice_Text"), gdjs.Login_95ScreenCode.GDNotice_9595TextObjects3);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
for (const obj of gdjs.Login_95ScreenCode.GDNotice_9595TextObjects2) asyncObjectsList.addObject("Notice_Text", obj);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Login_95ScreenCode.asyncCallback11923108(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Login_95ScreenCode.asyncCallback12328172 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Login_95ScreenCode.asyncCallback12328172(runtimeScene, asyncObjectsList)));
}
}
...
{ //Subevents
gdjs.Login_95ScreenCode.eventsList7(runtimeScene);} //End of subevents
}
...
gdjs.Login_95ScreenCode.eventsList8(runtimeScene);
}
